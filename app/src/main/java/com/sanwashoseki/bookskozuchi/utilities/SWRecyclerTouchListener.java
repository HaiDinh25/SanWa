...
public class SWRecyclerTouchListener implements RecyclerView.OnItemTouchListener, SWOnActivityTouchListener {
...
//                    vibe.vibrate(100); // do we really need to add vibrate service
    ...
    public SWRecyclerTouchListener(Activity a, RecyclerView recyclerView) {
        this.act = a;
...
//        mSwipeListener = listener;
    ...
    public SWRecyclerTouchListener setClickable(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public SWRecyclerTouchListener setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public SWRecyclerTouchListener setLongClickable(boolean vibrate, OnRowLongClickListener listener) {
        this.longClickable = true;
        this.mRowLongClickListener = listener;
        this.longClickVibrate = vibrate;
        return this;
    }
    public SWRecyclerTouchListener setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
    }

    public SWRecyclerTouchListener setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public SWRecyclerTouchListener setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
    }

    public SWRecyclerTouchListener setIgnoredViewTypes(Integer... viewTypes) {
    ...
    public SWRecyclerTouchListener setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
    ...
    public SWRecyclerTouchListener setSwipeable(boolean value) {
    ...
    public SWRecyclerTouchListener setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public SWRecyclerTouchListener setUnSwipeableRows(Integer... rows) {
    ...
    public SWRecyclerTouchListener setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    // the entire foreground is faded out as it is opened
    public SWRecyclerTouchListener setFgFade() {
...
//                        }
    ...
    public interface RecyclerTouchListenerHelper {
        void setOnActivityTouchListener(SWOnActivityTouchListener listener);
    }
