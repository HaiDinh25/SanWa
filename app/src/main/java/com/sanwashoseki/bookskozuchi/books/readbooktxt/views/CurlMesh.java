...
public class CurlMesh {
    ...
    private static final float[] SHADOW_INNER_COLOR = {0.000f, 0.100f, 0.200f, 0.300f};
    private static final float[] SHADOW_OUTER_COLOR = {0.000f, 0.000f, 0.000f, 0.000f};
    ...
    public CurlMesh(int maxCurlSplits) {
        ...
        if (DRAW_SHADOW) {
            mArrSelfShadowVertices = new Array<>((mMaxCurlSplits + 2) * 2);
            mArrDropShadowVertices = new Array<>((mMaxCurlSplits + 2) * 2);
            mArrTempShadowVertices = new Array<>((mMaxCurlSplits + 2) * 2);
...
//	}
    ...
    public void setRect(RectF r, boolean ltr) {
        if (ltr) {
